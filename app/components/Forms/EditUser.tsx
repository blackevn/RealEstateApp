  ...
  <div className="p-8 shadow-lg">
      <form className="space-y-4">
          <div className="w-full ">
              ...
              <Input icon={FaUser} name='name' value={editData.name} modifier="input w-full" placeholder="Name" type="text" id="name" />
          </div>

          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              <div>
                  <label className="sr-only" htmlFor="email">Email</label>
                  <Input icon={FaAt} name="email" value={editData.email}  modifier="input w-full" placeholder="Email address" type="email" id="email" />
              </div>
